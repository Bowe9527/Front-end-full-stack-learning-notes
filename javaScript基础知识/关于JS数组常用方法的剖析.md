...
返回：被删除的那一项内容
原有数组改变
![Alt text](./images/1522807069512.png)
...
返回：被删除的那一项内容
原有数组改变
![Alt text](./images/1522807360042.png)
...
返回：新增后数组的长度
原有数组改变
![Alt text](./images/1522807538601.png)
...
![Alt text](./images/1522808089473.png)

`新增：ary.splice(n,0,x,...)`
从索引n开始删除零项（没删除），把X或者更多需要插入的内容存放到数组中索引N的“前面”
![Alt text](./images/1522808358011.png)

`修改：ary.splice(n,m,x,...)`
修改的原理就是把原有内容删除掉，然后用新的内容替换这部分信息即可
![Alt text](./images/1522808496818.png)
...
ary[ary.length]=100
```
![Alt text](./images/1522808841799.png)
![Alt text](./images/1522808913543.png)

![Alt text](./images/1522809139917.png)
...
返回：以一个新数组存储查找的内容
原有数组不会变
![Alt text](./images/1522810059943.png)
...
返回：拼接后的新数组
原有数组不变
![Alt text](./images/1522810449422.png)
...
返回：字符串
原有数组不变 
![Alt text](./images/1522810872841.png)
...
返回：排列后的新数组
原有数组改变
![Alt text](./images/1522813231158.png)
...
返回：索引
原有数组不变
![Alt text](./images/1522814181449.png)
